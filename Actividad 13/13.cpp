...
int main(){
    ...
    do{
        ...
        cout<< "Menu: \n\t1) Agregar Libro\n\t2) Ver Libros"
            << "\n\t3) Eliminar libro\n\t4) Buscar Libro"
            << "\n\t6) Buscal Libro en espanol\n\t7) Buscar libro de ciencia ficcion"
            << "\n\t8) Eliminar libro de misterio"
            << "\n\t9) Salir\n\tOpcion elegida: ";
        cin >> opcion;
        switch(opcion){
			...
			case 8: cout << "Eliminando libro de misterio..." << endl;
            eliminarLibroMis();
        }
    }while(continuar);
